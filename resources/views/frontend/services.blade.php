                ...
                <div class="col-lg-10 col-md-12 col-12">
                    <div class="logo-section">
                        ...
                        <div class="logo-container">
                            <!-- Logo asli -->
                            <img src="{{asset('assets/images/logo.png')}}" alt="Logo 1">
                            <img src="{{asset('assets/images/logo.png')}}" alt="Logo 2">
                            <img src="{{asset('assets/images/logo.png')}}" alt="Logo 3">
                            <img src="{{asset('assets/images/logo.png')}}" alt="Logo 4">
                            <img src="{{asset('assets/images/logo.png')}}" alt="Logo 5">
                            <img src="{{asset('assets/images/logo.png')}}" alt="Logo 6">
                            <img src="{{asset('assets/images/logo.png')}}" alt="Logo 7">
                            <img src="{{asset('assets/images/logo.png')}}" alt="Logo 8">
                            <img src="{{asset('assets/images/logo.png')}}" alt="Logo 9">
                            <img src="{{asset('assets/images/logo.png')}}" alt="Logo 10">
                        </div>
                    </div>
                </div>
            </div>
