            ...
            <div class="col-lg-10 col-md-12 col-12">
                ...
                <div class="services-wrapper">
                    <div class="services-container">
                        <div class="team-member" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="300">
                            <img src="{{asset('assets-fe/images/services.webp')}}" alt="Team Member 1">
                            <h3>John Doe</h3>
                            <p>CEO & Founder</p>
                        </div>
                        <div class="team-member" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="300">
                            <img src="{{asset('assets-fe/images/services.webp')}}" alt="Team Member 2">
                            <h3>Jane Smith</h3>
                            <p>Lead Analyst</p>
                        </div>
                        <div class="team-member" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="300">
                            <img src="{{asset('assets-fe/images/services.webp')}}" alt="Team Member 3">
                            <h3>Alice Johnson</h3>
