                                    ...
                                    <div class="row g-2">
                                        <div class="col-md-6">
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <p class="mb-0">
                                                        <a href="mailto:{{ $informationContact->email ?? 'info@benevita.com' }}" class="text-decoration-none text-dark">
                                                            {{ $informationContact->email ?? 'info@benevita.com' }}
                                                        </a>
                                                    </p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div class="flex-grow-1 ms-2">
                                                    <p class="mb-0 small">
                                                        <a href="tel:{{ $informationContact->phone ?? '+621234567890' }}" class="text-decoration-none text-dark">
                                                            {{ $informationContact->phone ?? '+62 123 4567 890' }}
                                                        </a>
                                                    </p>
                                                </div>
                                            </div>
                                ...
                                <div class="social-media-box bg-white p-2 rounded-3 shadow-sm mt-3 text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        @foreach($social_media as $media)
                                            <a href="{{ $media->url }}" target="_blank" class="text-success fs-6 me-4">
